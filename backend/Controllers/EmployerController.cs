...
namespace backend.Controllers
{
    public class EmployerController : Controller
    {
        ...
        //        // Get job seeker email by application id
        //        string seekerEmail = employerRepository.GetSeekerEmailByApplicationId(id); // You'll implement this
        ...
        //                "Congratulations! Your job application has been approved."
        //            );
        //        }
        ...
        public ActionResult ApplicationApprove(int id, int aid)
        {
            try
            {
                ...
                var companyName = employerRepository.GetCompanyNameByEmployerId(Convert.ToInt32(Session["EmployerId"]));
                var seekerEmail = employerRepository.GetSeekerEmailByApplicationId(id);

                if (employerRepository.JobApplicationApprove(id))
                {
                    string subject = "Your Application has been Approved";
                    string body = $"Dear Candidate,\n\nCongratulations! Your application has been approved by {companyName}.\n\nWe wish you success in the next steps.\n\nRegards,\n{companyName}";
